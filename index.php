...
<div class="content_wrapper">
	...
	<div id="headline">
		...
		<span>-Total Items: <?php items (); ?> -Total Price:<?php total_price();?> - <a href="cart.php" style="color: #D9B20D">Go to cart</a> <a href="sujan.php" style="color: ">&nbsp; &nbsp;-Filter By price</a>
			&nbsp;<?php
			if(!isset($_SESSION['customer_email'])){
...
<div class="footer">
		...
		<div class="footer-section about">
                        ...
                        <div class="footer-col-1">
                            ...
                            <p style="padding:5px; text-align: left">Download App On Andriod and ios phone.</p>
                            <div class>
							<a href><img =></a>
...
<h2 style="padding:20px; text-align: center">&copy; 2021 - By www.doken.com</h2>
